...
user1 = User('Hillary', 'Kibet', 'Hillary@gmail.com')
teacher1 = Teacher('Mule', 'Anthony', 'Anthony@gmail.com')
Student1 = Student('Tony', 'Kipyegon', 'TonyKipyegon@gmail.com', 3.0)

print(user1.get_items())
